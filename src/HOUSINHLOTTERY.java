 ...
 * @author DN
 */
public class HOUSINHLOTTERY extends javax.swing.JFrame {

  Connection conn;
    ResultSet rs;
    PreparedStatement pst;
    public HOUSINHLOTTERY() {
        initComponents();
    ...
    public void balance() {
        try{
              String sql="Select Sum(value) as sumprice from lottery";
    ...
    public void tabledata() {
        String sql="select  acc_number,name,date,value from lottery";
        try{
        pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("HOUSING LOTTERY");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HOUSINHLOTTERY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HOUSINHLOTTERY().setVisible(true);
            }
        });
    }
